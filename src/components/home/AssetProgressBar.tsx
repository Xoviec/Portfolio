...
export const AssetProgressBar = ({progress}) => {
    ...
    <div>
        <div className={`flex items-center justify-center w-[100%]  h-12 rounded-xl bg-[#5b7fb3]  overflow-hidden`}>
            ...
            <div style={{width:progress+'%', transition: 20}} className={`flex items-center justify-center h-[100%]  bg-[#007aff] duration-700 ease-in-back text-[1.2rem] font-bold text-[#d4e1f4]`}>
            {/* {
