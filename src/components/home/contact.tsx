...
export const Contact = ({progress, setProgress}) =>{
    ...
    return(
        <div className="flex flex-col items-center">
            ...
            <div className="bg-[#2a476e9e] h-[500px]d max-w-[1200px] flex items-center justify-center rounded-lg  p-5 mt-10 md:flex-col sm:w-[350px]">
                ...
                <form className="flex flex-col gap-5 w-[1000px] p-4 lg:w-[500px] sm:w-[350px]" action="">
                    ...
                    <button className="bg-[#007aff] rounded-xl  text-[1.2rem] font-bold text-[#d4e1f4] outline-none"  type={progress == 100 ? 'submit' : 'button'} >
                        <div>
